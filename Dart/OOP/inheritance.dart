...
// create an Employee object
  ...
  var s = Student.withUpperCase( 'Rachel', 'Green', 418 );
...
class Person {
  ...
  //named constructor
  Person.withUpperCase(this.lastName, this.firstName) {
...
//Student class shares features of Person class
class Student extends Person {
  num score;

// default constructor calls `Person.withUpperCase` constuctor function of `Person` class
  Student.withUpperCase(String lastName, String firstName, this.score) : super.withUpperCase(lastName, firstName) {
    this.score = num.parse(((score/500)*100).toStringAsFixed(6)); // limit decimal places to 2
  }
}